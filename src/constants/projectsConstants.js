import bijliIcon from "~assets/icons/project-icon-bijli.png";
import wakencyIcon from "~assets/icons/project-icon-wakency.png";
import nykaaIcon from "~assets/icons/project-icon-nykaa.png";
import pulseIcon from "~assets/icons/project-icon-pulse.png";
import lighthouseIcon from "~assets/icons/project-icon-lighthouse.png";
import benefactoryIcon from "~assets/icons/project-icon-benefactory.png";
import measureIcon from "~assets/icons/project-icon-measure.png";
import vcMusicPlayerIcon from "~assets/icons/project-icon-vc-music-player.png";
  ...
  Project1: {
    ...
    description: [
      ...
      },
      {
        type: "text",
        value:
          "In Bijli I mostly worked on React and Electron, and worked with Laravel for one feature.<br/>Have Architectured Home page components to connect with other tabs which communicate with each other and handle realtime data updates.",
      },
      {
        type: "points",
    ...
    description: [
      {
        ...
        highlight: "green",
        value:
          "Nykaa is an e-commerce website offering beauty and wellness products from more than 500 leading brands. <br/><br/>Nykaa follows an inventory-based model with warehouses in Mumbai, New Delhi, and Chennai as its offline presence is in 60 stores and expanding",
      },
      {
        type: "header",
        value: "My Contribution :",
      },
      {
        type: "text",
        value:
          "I was actively involved in building new features like new signup/signin flow, had introduced a AR makeup try-on using Modi-face for the iOS webview with stage releases.<br/>Also maintained entire Nykaa Pro module while working on these new features.",
      },
      {
        type: "points",
        value: [
  ...
  Project4: {
    ...
    description: [
      ...
      },
      {
        ...
        highlight: "green",
        value:
          "The purpose of the Sprout app users is to quickly and conveniently book meals from Sprout.<br/> It was not published due to some business operation issue on the clients end.",
      },
      {
        type: "header",
        value: "My Contribution :",
    ...
    description: [
      {
        ...
        highlight: "green",
        value:
          "Measure is an fitness app which helps track habit and weight to provide detailed information about your health so that the user can make informed decisions about their health.<br/>The app is integrated with their weighing scale device so the weight data is directly taken from the device.",
      },
      {
        type: "header",
        value: "My Contribution :",
      },
      {
        type: "text",
        value:
          "Created this apps BLE paring system to connect with the clients smart Weighing scale device using Androids BluetoothGatt Class along with the Charts and rest of the flow except onboarding flow.",
      },
      {
        type: "text",
